      ...
      <div class="col-6 d-flex justify-content-center align-items-center h-100">
        <form @submit.prevent="onSubmit" class="col-6">
          ...
          <div class="form-group" :invalid-feedback="invalidFeedback">
            <input class="form-control" v-model="username" type="text" placeholder="Username" required>
          </div>
          ...
          <div class="form-group d-flex justify-content-between">
            ...
            <a href="/forgot" style="color: #999;">Forget Password</a>
          </div>

          <div class="form-group text-center d-flex">
            <div class="col-12">
              <input type="submit" class="btn btn-bora btn-block sign_btn" value="Login" />
            </div>
            <!-- <div class="col-6">
              <input type="button" class="btn outline-bora btn-block" value="Sign up" />
            </div> -->
          </div>
          <a href='/fcustom'>Try Free</a>
        </form>
